...
public class VehicleSharingPackage {
    ...
    public VehicleSharingPackage(){
         ...
         */
        this(BigDecimal.ZERO, 0, 0, new BigDecimal(1200.59), new BigDecimal(2.0), BigDecimal.ZERO, BigDecimal.ZERO, new BigDecimal(1.0), BigDecimal.ZERO, new BigDecimal(3.0), 1, 1, BigDecimal.ZERO);
    }
